...
[_LOWER] = LAYOUT_planck_grid(
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,          KC_CIRC, KC_AMPR,    KC_ASTR,    KC_MINUS, KC_KP_PLUS, KC_BSPC,
    KC_DEL,  KC_LABK, KC_LBRC, KC_LCBR, KC_LPRN, KC_DOUBLE_QUOTE,  KC_EQL,  KC_RPRN,    KC_RCBR,    KC_RBRC,  KC_RABK,    KC_PIPE,
